...
const Cart = () => {
    ...
    const cartTotal = () => {
        return cart.reduce((acc, item) => acc + item.product.price *30 * item.quantity, 0)
    }
                                ...
                                <div className="item" key={item.product.id}>
                                    <div className="grid py-3">
                                        ...
                                        <div className="itemDesc">
                                            ...
                                            <span className="price">₹{round(item.product.price *30* item.quantity, 2)}</span>
                        ...
                        <div className="payment p-3">
                            ...
                            <div className="summary py-3 my-2">
                                ...
                                <div className="flex py-1">
                                    ...
                                    <span className="price">₹{SHIPPING_CHARGES*5}</span>
                                </div>
                                <div className=" flex py-1">
                                    <span>Total:</span>
                                    <span className="price">₹{round(cartTotal() + SHIPPING_CHARGES*5, 2)}</span>
                                </div>
                            </div>
                        </div>
                    </div>
